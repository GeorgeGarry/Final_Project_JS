...
// import { Save_recipe_to_favorites } from "../../backend/modules/save_recipe_to_favorites";
...
const Recipe_card = (props) => {
    ...
    const send_recipe_to_server_db = async (dish_card) => {
        try {
            ...
            // const data = response.then(resp => console.log("getting responce on front: ",resp))
        ...
        <div className="recipe-container">
            {cards_array.map((dish) => (
                <div className="recipe-card">
                    ...
                    {user_id != "" && <button onClick={() => send_recipe_to_server_db(dish)}>Save to favorites</button>}
                </div>
